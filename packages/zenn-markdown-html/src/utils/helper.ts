...
function generateYoutubeHtml(videoId: string, start?: string) {
  ...
  return `<div class="embed-youtube"><iframe class="lazy" data-src="https://www.youtube.com/embed/${escapedVideoId}?loop=1&playlist=${escapedVideoId}${startQuery}" allowfullscreen loading="lazy"></iframe></div>`;
}
